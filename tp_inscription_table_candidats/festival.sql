...
--
-- Hôte : 127.0.0.1
-- Généré le :  mer. 24 nov. 2021 à 16:03
...
(1, 'Barbier', 'Damien', 'test@yahoo.fr', '$2y$10$eL68YaCehlut8Icq4p1OyustF0JjyXIbUxzKamDs7n6z7cVW/fEqm', 10, 25),
(2, 'Jimmy', 'sumerville', 'test@test.fr', '$2y$10$3/rTymAHHOf/wAm01NEG4e0aq6tTdD7.P/Bmt0WSYwhpOVBiFgJeG', 12, 25),
(3, 'Jimmy', 'sumerville', 'test@test.fr', '$2y$10$whn811md6CUCbnW.0PbaduXOtFH9yJ0eqimFoCDdAjDwa2aumhf5i', 12, 25);
...
ALTER TABLE `candidats`
  ...
  ADD KEY `fk_num_dep` (`departement_user`);
...
--
ALTER TABLE `candidats`
  ADD CONSTRAINT `fk_num_dep` FOREIGN KEY (`departement_user`) REFERENCES `departements` (`id_dep`);
COMMIT;
